...
// Backing services for the local dev run (see TestVirtualThreadOrderApplication).
// The images match what the Helm chart deploys, so a developer's Mongo and
// Kafka behave like the cluster's without anything to keep in sync by hand.
//
