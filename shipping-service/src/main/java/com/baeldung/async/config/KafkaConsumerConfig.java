...
public class KafkaConsumerConfig {
    ...
    public ConcurrentKafkaListenerContainerFactory<Object, Object> kafkaListenerContainerFactory(
        ...
        // orders' worth of PREPARE_SHIPPING messages concurrently instead of one poll loop
        // handling every partition serially. Keep this <= partition count; extra threads
        // beyond that would just sit idle with no partition to claim.
