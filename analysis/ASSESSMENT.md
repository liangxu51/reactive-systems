...
6. **Dead seed-data loader** — see Dangling References above; self-documented broken code that looks functional to a new contributor. *(Still open.)*
